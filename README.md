...
Na parte de perfil do prestador de serviço temos um botão para editar perfil no canto superior direito, logo abaixo é mostrado o nome da pessoa, qual a sua área de especialização, onde mora, qual a nota que os clientes dão para esta pessoa, o telefone, email e se esta disponivel para novas vagas.
